/**
 * OVERLOAD - Spatial Reasoning Adaptive Difficulty Manager
 * Deterministic rolling-window performance progression for Spatial Reasoning.
 */

import { SPATIAL_DIFFICULTY_PARAMS } from './spatialConstants.js';
 ...
 */
export function calculateNextSpatialDifficulty({
  currentLevel = SPATIAL_DIFFICULTY_PARAMS.initialLevel,
  recentEvaluations = [],
  consecutiveCorrect = 0,
  consecutiveErrors = 0,
} = {}) {
  const minLevel = SPATIAL_DIFFICULTY_PARAMS.minLevel;
  const maxLevel = SPATIAL_DIFFICULTY_PARAMS.maxLevel;
...
export default {
  calculateNextSpatialDifficulty,
};
