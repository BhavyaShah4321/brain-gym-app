/**
 * OVERLOAD - Cognitive Flexibility Adaptive Difficulty Manager
 * Deterministic rolling-window performance progression for Cognitive Flexibility.
 */

import { FLEXIBILITY_DIFFICULTY_PARAMS } from './flexibilityConstants.js';
 ...
 */
export function calculateNextFlexibilityDifficulty({
  currentLevel = FLEXIBILITY_DIFFICULTY_PARAMS.initialLevel,
  recentEvaluations = [],
  consecutiveCorrect = 0,
  consecutiveErrors = 0,
} = {}) {
  const minLevel = FLEXIBILITY_DIFFICULTY_PARAMS.minLevel;
  const maxLevel = FLEXIBILITY_DIFFICULTY_PARAMS.maxLevel;
...
export default {
  calculateNextFlexibilityDifficulty,
};
